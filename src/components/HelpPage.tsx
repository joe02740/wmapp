      ...
      <div className="help-section">
        ...
        <div className="example-conversation">
          ...
          <div className="conversation-flow">
            ...
            <div className="ai-example">
              <strong>W&M Helper:</strong> "Based on the most recent Massachusetts weights and measures regulations (202 CMR 5.00), here are the key requirements for electronic price tags: ## Electronic Shelf Label Requirements **Automatic Update Restrictions:** - Electronic shelf labels may **only be automatically updated when the store is closed** to consumers - For 24-hour stores, updates are restricted to **1:00 a.m. to 3:00 a.m. only** **Display Requirements:** - Must include both **unit price** and **item price** - Unit price segment: black typeface on contrasting background (yellow, red, orange, or other approved color) - Item price segment: black typeface on white background (unless otherwise approved) - **Exception:** Black and white contrasting labels are allowed in freezer sections or with written authorization from the Deputy Director **Font Size Requirements:** - Use the largest font size possible based on label size - Unit price font must be **at least 50% the size** of item price font - Minimum unit price font size: **6.00 mm** (unless approved otherwise) - Both prices must be in **bold typeface** **Content Requirements:** Unit price segment must include: - "Unit Price" heading above the numerical price - Price displayed to nearest cent $1.00 or tenth of cent $0.99 Item price segment must include: - Clear descriptor ("Item Price," "Retail Price," etc.) - Current sale price (including discounts) - Size/weight/volume information - Expiration date of temporary discounts (if applicable) **Compliance Period:** Stores have a **120-day grace period** to transition from old requirements to new electronic label standards. Would you like me to clarify any specific aspect of these electronic pricing requirements?"
            </div>
          </div>
        </div>
      </div>
